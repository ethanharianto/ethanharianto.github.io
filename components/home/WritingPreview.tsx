    ...
    <section id="writing" className="py-28 md:py-40 relative">
      <div className="shell">
        <SectionHeader
          ...
          description="Short essays on the things I'm building and reading."
          action={
            <Link
              href="/writing"
          ...
          {posts.map((post, idx) => (
            <Reveal key={post.slug} delay={idx * 0.06}>
              <Link
                ...
                className="group block h-full border border-[var(--color-hairline)] rounded-xl p-6 hover:border-[var(--color-hairline-strong)] hover:bg-[rgba(250,250,247,0.02)] transition-colors"
              >
                ...
                <span className="mt-8 inline-flex items-center gap-1 text-[12px] font-mono uppercase tracking-widest text-[var(--color-muted)] group-hover:text-[var(--color-ink)]">
                  Read
